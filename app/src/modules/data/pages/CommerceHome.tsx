...
import { type CountCustomsByClientType, type CountCustomsByDateType, type CountOrdersBystateIdType, countCustomsByClientQuery, countCustomsByDateQuery, countOrdersBystateIdQuery, countOrdersBystateQuery } from "../requests/commerceHome";
...
function CommerceHome() {
    ...
    const isLoading = () => ordersByStateId.isLoading || customsByClient.isLoading || customsByDate.isLoading;
    const isError = () => ordersByStateId.isError || customsByClient.isError || customsByDate.isError;
    const isSuccess = () => ordersByStateId.isSuccess && customsByClient.isSuccess && customsByDate.isSuccess;
            ...
            <Switch>
                ...
                <Match when={isSuccess()}>
                    <div class='h-full w-full flex flex-col md:grid md:grid-cols-2 gap-2'>
                        <OrdersByState data={ordersByStateId.data as CountOrdersBystateIdType} />
