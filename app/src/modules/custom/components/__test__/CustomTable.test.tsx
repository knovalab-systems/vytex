...
describe('Custom Table', () => {
	...
	it('does not render action cell if finished date is present', () => {
		const customs: GetCustomsType = [
			{ id: 123, client: 'pepe', created_at: '2024-05-12T22:36:52.140901Z', finished_at: '2024-06-12T22:36:52.140901Z' }
		];
	...
	it('does not render action cell if canceled date is present', () => {
		const customs: GetCustomsType = [
			{ id: 123, client: 'pepe', created_at: '2024-05-12T22:36:52.140901Z', canceled_at: '2024-06-12T22:36:52.140901Z' }
		];
	...
	it('renders action cell with create action if no finished or canceled date is present', () => {
		const customs: GetCustomsType = [
			{ id: 123, client: 'pepe', created_at: '2024-05-12T22:36:52.140901Z' }
		];
