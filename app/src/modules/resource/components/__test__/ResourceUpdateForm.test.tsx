...
describe('ResourceUpdateForm', () => {
    ...
    it('dont show error message when submit form', async () => {
        render(() => <ResourceUpdateForm
            resource={{
                name: 'Resource 1',
                code: 1,
        ...
        await waitFor(() => {
            ...
            expect(screen.queryByText('Ingresa el costo.')).not.toBeInTheDocument();
            expect(screen.queryByText('Selecciona un estado.')).not.toBeInTheDocument();
            expect(screen.queryByText('Selecciona un color.')).not.toBeInTheDocument();
            expect(screen.queryByText('Selecciona un proveedor.')).not.toBeInTheDocument();
        });
    });
