								...
								<TableBody>
									<For each={color.resources}>
										{resource => (
											<TableRow class='*:p-2 text-center'>
												<TableCell>
													{resource?.resource?.name} - {resource?.resource?.code}
												</TableCell>
												<TableCell>
													<div
														class='h-8 w-8 border'
												...
												<For each={SIZES}>{size => <TableCell>{resource?.[size] ?? '0'}</TableCell>}</For>
											</TableRow>
										)}
									</For>
									<For each={color.fabrics}>
										{fabric => (
											<TableRow class='*:p-2 text-center'>
												<TableCell>
													{fabric?.fabric?.name} - {fabric?.fabric?.code}
												</TableCell>
												<TableCell>
													<div
														class='h-8 w-8 border'
												...
												<For each={SIZES}>{size => <TableCell>{fabric?.[size] ?? '0'}</TableCell>}</For>
											</TableRow>
										)}
									</For>
								</TableBody>
