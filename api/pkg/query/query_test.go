...
func Test_WithContext(t *testing.T) {
	...
	for _, ctx := range []context.Context{
		...
		qCtx.ImageByReference.UnderlyingDB().Statement.Context,
		qCtx.Operation.UnderlyingDB().Statement.Context,
		qCtx.OperationalList.UnderlyingDB().Statement.Context,
		...
		qCtx.Role.UnderlyingDB().Statement.Context,
		qCtx.Session.UnderlyingDB().Statement.Context,
		qCtx.Step.UnderlyingDB().Statement.Context,
